...
Select up to `count` stories. Include **at most one** CVE entry; if a CVE appears, add a TLDR line with a 10‑word summary. All other entries should be regular cybersecurity news and must contain only:
